...
public class ComputeBigramRelativeFrequencyStripes_Bespin  extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(ComputeBigramRelativeFrequencyStripes_Bespin.class);
   ...
   */
  private ComputeBigramRelativeFrequencyStripes_Bespin() {}
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool name: " + ComputeBigramRelativeFrequencyStripes_Bespin.class.getSimpleName());
    ...
    job.setJobName(ComputeBigramRelativeFrequencyStripes_Bespin.class.getSimpleName());
    job.setJarByClass(ComputeBigramRelativeFrequencyStripes_Bespin.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new ComputeBigramRelativeFrequencyStripes_Bespin(), args);
  }
}
